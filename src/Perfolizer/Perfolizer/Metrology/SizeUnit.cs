    ...
    : MeasurementUnit(abbreviation, fullName, baseUnits)
{
    ...
    [PublicAPI] public static readonly SizeUnit MB = new("MB", "Megabyte", BytesInKiloByte.PowLong(2));
    [PublicAPI] public static readonly SizeUnit GB = new("GB", "Gigabyte", BytesInKiloByte.PowLong(3));
    [PublicAPI] public static readonly SizeUnit TB = new("TB", "Terabyte", BytesInKiloByte.PowLong(4));
