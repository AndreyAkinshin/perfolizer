...
public class PhdSimpleTests : PhdTestsBase
{
    ...
    private static PhdEntry CreateRoot()
    {
        ...
        PhdEntry CreateEntry(string benchmarkId) => new PhdAttributes
        {
            Meta = new PhdMeta
            {
                Table = new PhdTableConfig
                {
                    ...
                    [
                        ...
                        new PhdColumnDefinition("=average"),
            ...
            new PhdMetric { Id = "stage1", Value = NextValue(), Unit = TimeUnit.Millisecond },
            new PhdMetric { Id = "stage2", Version = 2, Value = NextValue(), Unit = TimeUnit.Millisecond },
            new PhdMetric { Id = "totalTime", Value = NextValue(), Unit = TimeUnit.Millisecond },
            new PhdMetric { Id = "Footprint", Value = 20, Unit = SizeUnit.MB },
            new PhdMetric { Id = "Gc.CollectCount", Value = 3 });
