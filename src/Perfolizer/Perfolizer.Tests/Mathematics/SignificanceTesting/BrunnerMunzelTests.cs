...
public class BrunnerMunzelTests
{
    ...
    public void BrunnerMunzelTest01()
    {
        ...
        Check(x, y, 0.416470332044473, 12.126760041271, 0.657828745852485);
    }
    ...
    public void BrunnerMunzelTest02()
    {
        ...
        Check(x, y, 0.810441509480792, 15.9157043954192, 0.78518059445665);
    }
    ...
    public void BrunnerMunzelTest03()
    {
        ...
        Check(x, y, double.PositiveInfinity, double.NaN, 1);
    }
    ...
    public void BrunnerMunzelTest04()
    {
        ...
        Check(x, y, double.NegativeInfinity, double.NaN, 0);
    }
    ...
    public void BrunnerMunzelTest05()
    {
        ...
        Check(x, y, 0.0730621536215222, 9.85667474591963, 0.528390995436648);
    }

    [AssertionMethod]
    private void Check(double[] x, double[] y, double w, double df, double pValue)
    {
        var threshold = AbsoluteThreshold.Zero;
        var result = BrunnerMunzelTest.Instance.IsGreater(x, y, threshold);
        if (result == null)
